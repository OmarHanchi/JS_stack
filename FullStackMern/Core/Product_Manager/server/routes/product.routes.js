...
module.exports = (app) => {
    ...
    app.patch("/api/product/update/:productId", productController.updateExistingproduct)
    app.put("/api/product/update/:productId", productController.updateExistingproduct)
